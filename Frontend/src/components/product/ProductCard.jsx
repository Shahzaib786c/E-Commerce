  ...
  return (
    <Link to={`/products/${product.id}`} className={`product-card ${outOfStock ? "is-out" : ""}`}>
      <div className="product-card-image">
        ...
        {product.isNew && <span className="badge badge-new product-card-badge">New</span>}
        {lowStock && (
          <span className="badge badge-low product-card-badge">Only {product.stock} left</span>
        )}
        {outOfStock && <span className="badge badge-out product-card-badge">Out of stock</span>}
      </div>
